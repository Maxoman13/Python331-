...
# Владимирб добрый день! Сделал два класа: TXT и JSON сам без вашего разбора(вроде бы все работало),
# пытался сделать CSV по такому же принципу и завис. Ваш разбор помог.
